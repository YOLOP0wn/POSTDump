    ...
    public static class MiniDump
    {
        ...
        private static List<Data.MiniDumpMemoryDescriptor64> write_memory64_list_stream(Data.dump_context dc, List<Data.PModuleInfo> modulelist)
        {
            ...
            foreach (Data.MiniDumpMemoryDescriptor64 range in memory_ranges)
            {
                ...
                uint ByteRead = 0;
                NtReadVirtualMemory NTRVM = (NtReadVirtualMemory)Marshal.GetDelegateForFunctionPointer(POSTDump.Postdump.isyscall.ntreadptr, typeof(NtReadVirtualMemory));
        ...
        private static List<Data.MiniDumpMemoryDescriptor64> get_memory_range(Data.dump_context dc, List<Data.PModuleInfo> module_list)
        {
            ...
            while (true)
            {
                ...
                NtQueryVirtualMemory NTQVM = (NtQueryVirtualMemory)Marshal.GetDelegateForFunctionPointer(POSTDump.Postdump.isyscall.ntqueryptr, typeof(NtQueryVirtualMemory));
