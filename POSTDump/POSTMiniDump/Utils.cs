...
namespace POSTMiniDump
{
    public static class Utils
    {
        ...
        public static extern void RtlInitUnicodeString(ref Data.UNICODE_STRING DestinationString, [MarshalAs(UnmanagedType.LPWStr)] string SourceString);
        ...
        public static void erase_dump_from_memory(IntPtr baseaddr, ulong RegionSize)
        {
            RtlZeroMemory(baseaddr, RegionSize);
            RegionSize = 0;
            IntPtr ntfreeptr = POSTDump.Postdump.isyscall.GetSyscallPtr("NtFreeVirtualMemory");
            NtFreeVirtualMemory NTFVM = (NtFreeVirtualMemory)Marshal.GetDelegateForFunctionPointer(ntfreeptr, typeof(NtFreeVirtualMemory));
